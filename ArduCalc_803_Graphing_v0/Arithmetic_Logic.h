...
extern float cosine;
extern float sine;
extern float *cos_point;
extern float *sine_point;
extern float *tan_point;
extern float tangent;
...
class Arithmetic_Logic {
  ...
  private:
    ...
    float logic_cosine;
    float logic_tangent;
    float *logic_cos_point;
    float *logic_sine_point;
    float *logic_tan_point;
};
